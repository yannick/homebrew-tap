# Tap-pinned copy of homebrew-core's mlx-c at v0.6.0 — the exact version the
# published mlx-serve binaries are built against. Normally you should use the
# core formula (`brew install mlx-c`); install this one explicitly
...
# Source-built: no bottles in this tap.
class MlxC < Formula
  desc "C API for MLX"
